                ...
                <SwipeListView
                  ...
                  renderItem={(data, rowMap) => (
                    <List style={{ height: 160 }}  >
                      <ListItem avatar style={{ height: 150 }} button onPress={() => { this.props.navigation.push('check_detail', { 'itemId': element.id_book, 'ID2': element.user_mem }) }}>
                            ...
                            {element.status_mem == 1 ?
                              element.status_payment == 0 ?
                                <Row>
                                  ...
                                  <Text style={{ fontFamily: Fonts.PrintAble4U }}>  รอการตรวจสอบหลักฐานการโอน</Text>
                                </Row>
                                :
                                <Row>
                                  <Button style={{ width: 15, height: 15, borderRadius: 15, backgroundColor: 'green' }}><Text> </Text></Button>
                                  <Text style={{ fontFamily: Fonts.PrintAble4U }}>  ยืนยันหลักฐานการโอนแล้ว</Text>
                                </Row>
                              :
                              <Row>
                                <Button style={{ width: 15, height: 15, borderRadius: 15, backgroundColor: 'red' }}><Text> </Text></Button>
                                <Text style={{ fontFamily: Fonts.PrintAble4U }}>  รอการชำระเงิน</Text>
                              </Row>
                            }
