      ...
      <Container style={{backgroundColor:'#d2d2d2'}}>
        ...
        <Footer>
          <FooterTab style={{backgroundColor:'#f9b40f'}}>
            ...
            <Button vertical active style={{backgroundColor:'#f9b40f'}} onPress={() => { this.props.navigation.push('gym_detail') }}>
              <Icon active name="pin" />
              <Text style={{fontFamily:Fonts.PrintAble4U}}>ข้อมูลยิม</Text>
            </Button>
            <Button vertical onPress={() => { this.props.navigation.push('notifications') }}>
